    ...
    return (
        <div className="min-h-screen bg-[#05070b] text-white font-sans overflow-x-hidden selection:bg-[#ff7a00]/30 selection:text-[#ff7a00]">
            ...
            <section
                ...
                style={{
                    backgroundImage:
                        "linear-gradient(to right, rgba(5,7,11,0.96) 30%, rgba(5,7,11,0.75) 60%, rgba(5,7,11,0.40) 100%), url('/unsplash/wind-battery.jpg')",
                }}
            >
                {/* Breadcrumb */}
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-center">
                        ...
                        <div className="lg:col-span-5 flex flex-col gap-6 mt-10 lg:mt-0">
                            {[
                                ...
                                { icon: <Zap size={20} />, color: "#ff7a00", title: "MAXIMUM PERFORMANCE", desc: "Advanced turbines. AI-driven monitoring." },
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-stretch">
                        ...
                        <div className="lg:col-span-8 bg-[#0f1117] border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
                            ...
                            <div
                                ...
                                style={{ backgroundImage: "url('/unsplash/wind-battery.jpg')" }}
                            />
                        </div>
            ...
            <section className="py-4 bg-[#05070b] border-t border-white/5">
                <div className="w-full px-[50px]">
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "linear-gradient(to right, rgba(10,12,18,0.97) 0%, rgba(10,12,18,0.88) 55%, rgba(10,12,18,0.70) 100%), url('/unsplash/wind-battery.jpg')",
